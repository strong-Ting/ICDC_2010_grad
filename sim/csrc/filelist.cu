...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _24868_archive_1.so
_24868_archive_1.so : archive.1/_24868_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared -m elf_i386  -Bsymbolic  -o .//../simv.daidir//_24868_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_24868_archive_1.so $@
