...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _1468_archive_1.so
_1468_archive_1.so : archive.22/_1468_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared -m elf_i386  -Bsymbolic  -o .//../simv.daidir//_1468_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_1468_archive_1.so $@


ARCHIVE_OBJS += _prev_archive_1.so
_prev_archive_1.so : archive.22/_prev_archive_1.a
	@$(AR) -s $<
